...
export default {
  ...
  methods: {
    ...
    viewApplication(index, row) {
      this.$router.push({ path: "/oms/exWarehouseDetail", query: { id: row.id } });
    },
    editApplication(index, row) {
      this.$router.push({ path: "/oms/createExWarehouseApplication", query: { id: row.id } });
    },
    ...
    submitApplication() {
      this.$router.push({
        path: "/oms/createExWarehouseApplication",
      });
    },
  },
};
